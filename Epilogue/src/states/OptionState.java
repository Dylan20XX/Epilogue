...
public class OptionState extends State { // inherent fields
	...
	public OptionState(ControlCenter c) {
		...
		// adding the buttons
		uiManager.addObject(new ImageButton((int) (200 * ControlCenter.scaleValue),
				(int) ((c.getHeight() - 130) * ControlCenter.scaleValue), (int) (48 * ControlCenter.scaleValue),
				(int) (44 * ControlCenter.scaleValue), Assets.sLeft, new ClickListener() {
