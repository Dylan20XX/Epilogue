...
public class Recipe {
	...
	private void setupRecipeRequirements() {
		...
		if (id == 0) {
			...
			recipeRequirements.put(Item.leatherItem.getId(), 1);//20
			recipeRequirements.put(Item.ironBarItem.getId(), 1);//2
			recipeRequirements.put(Item.tinIngotItem.getId(), 1);//8
		} 
