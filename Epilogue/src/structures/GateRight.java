...
public class GateRight extends StaticEntity{
	...
	private Rectangle secondaryBounds = new Rectangle(StaticEntity.DEFAULT_STATICOBJECT_WIDTH - width, 0, width, height);

	public GateRight(double x, double y, int wallType, ControlCenter c) {
