...
public class PineTree extends StaticEntity{
    ...
    public PineTree(double x, double y, ControlCenter c) {
    ...
    public void render(Graphics g) {
        ...
        g.drawImage(Assets.pineTree, (int)(x - c.getGameCamera().getxOffset()), (int)(y - c.getGameCamera().getyOffset()),
        		width, height, null);
	...
	public void Die() {
        ...
        for(int i = 0; i < CT.random(0, 2); i++) 
        	c.getMenuState().getWorldSelectState().getGameState().getWorldGenerator()
			.getItemManager().addItem(Item.sapItem.createNew((int) x + bounds.x + CT.random(0, bounds.width), (int) y + bounds.y + CT.random(0, bounds.height)));
