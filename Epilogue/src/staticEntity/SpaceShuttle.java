...
public class SpaceShuttle extends StaticEntity {
	...
	public SpaceShuttle(double x, double y, ControlCenter c) {
		...
		bounds.width = width - Tile.TILEWIDTH / 2 - 15;
		bounds.height = height - Tile.TILEHEIGHT / 2 - 60;
		bounds.x = width / 2 - bounds.width / 2 - 15;
		bounds.y = height / 2 - bounds.height / 2 + 30;
	...
	public void render(Graphics g) {
		g.drawImage(shuttleAppearence, (int) (x - c.getGameCamera().getxOffset()),
				(int) (y - c.getGameCamera().getyOffset() - height / 1.25), width, (int) (height * 2.5), null);
